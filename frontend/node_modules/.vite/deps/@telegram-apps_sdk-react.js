...
var ce = (e, t, s) => t in e ? ae(e, t, { enumerable: true, configurable: true, writable: true, value: s }) : e[t] = s;
var c = (e, t, s) => ce(e, typeof t != "symbol" ? t + "" : t, s);
function Rt(e, t) {
  let s;
  const n = () => {
...
var W = class _W extends Error {
  constructor(t, s, n) {
    super(s, { cause: n }), this.type = t, Object.setPrototypeOf(this, _W.prototype);
  }
};
function m(e, t, s) {
  return new W(e, t, s);
}
var de = "ERR_METHOD_UNSUPPORTED";
var _e = "ERR_METHOD_PARAMETER_UNSUPPORTED";
var ge = "ERR_UNKNOWN_ENV";
var we = "ERR_INVOKE_CUSTOM_METHOD_RESPONSE";
var fe = "ERR_TIMED_OUT";
var me = "ERR_UNEXPECTED_TYPE";
var Ct = "ERR_PARSE";
var be = "ERR_NAVIGATION_LIST_EMPTY";
var ve = "ERR_NAVIGATION_CURSOR_INVALID";
var _n = "ERR_NAVIGATION_ITEM_INVALID";
var gn = "ERR_SSR_INIT";
var ye = "ERR_INVALID_PATH_BASE";
function T() {
...
var qe = class {
  ...
  set(t, s) {
    Object.entries(typeof t == "string" ? { [t]: s } : t).reduce((n, [r, i]) => this.state[r] === i || i === void 0 ? n : (this.state[r] = i, this.ee.emit(`change:${r}`, i), true), false) && this.ee.emit("change", this.state);
  }
  /**
...
var Lt = A((e) => e instanceof Date ? e : new Date(x().parse(e) * 1e3), "Date");
function ut(e, t) {
  return new G((s) => {
...
var Qe = l(
  ...
  ({
    postEvent: e,
    state: t = { isConfirmationNeeded: false }
...
var as = l(
  ({ version: e, postEvent: t }) => new os(false, e, t)
);
var cs = class extends ht {
   ...
   */
  disable() {
    return this.isEnabled = false, this;
  }
  /**
   ...
   */
  hide() {
    return this.isVisible = false, this;
  }
  /**
   * Hides the MainButton loading indicator.
   */
  hideLoader() {
    return this.isLoaderVisible = false, this;
  }
  set isEnabled(t) {
   ...
   */
  show() {
    return this.isVisible = true, this;
  }
  /**
   * Shows a loading indicator on the Main Button.
   */
  showLoader() {
    return this.isLoaderVisible = true, this;
  }
  /**
...
var ls = class extends $ {
  constructor({ postEvent: t, createRequestId: s, version: n, botInline: r, ...i }) {
    ...
    this.supports = (a) => o(a) ? a !== "switchInlineQuery" || r : false, this.supportsParam = Yt(n, {
...
var ws = l(
  ({ postEvent: e, version: t }) => new gs(false, t, e)
);
var fs = class extends $ {
   ...
   */
  close() {
    this.postEvent("web_app_close_scan_qr_popup"), this.isOpened = false;
  }
  set isOpened(t) {
    this.set("isOpened", t);
  }
...
var ms = l(
  ({ version: e, postEvent: t }) => new fs(false, e, t)
);
var bs = class extends pt {
  constructor(t, s, n) {
    super({ isVisible: t }, s, {
...
var xs = class extends dt {
   ...
   */
  expand() {
    this.postEvent("web_app_expand"), this.set("isExpanded", true);
  }
  /**
...
var Cs = l(
  ...
  async ({ state: e, platform: t, postEvent: s, addCleanup: n }) => {
    let r = false, i = 0, o = 0, a = 0;
    if (e)
      r = e.isExpanded, i = e.height, o = e.width, a = e.stableHeight;
    else if (["macos", "tdesktop", "unigram", "webk", "weba", "web"].includes(t))
      r = true, i = window.innerHeight, o = window.innerWidth, a = window.innerHeight;
    else {
...
function Ss(e = true) {
  ...
  return V("iframe_ready", { reload_supported: true }), s;
}
function Ts() {
...
async function Pn() {
  if (kt(window))
    return true;
  try {
    return await g({ method: "web_app_request_theme", event: "theme_changed", timeout: 100 }), true;
  } catch {
    return false;
  }
}
...
var Is = class {
  constructor(t, s, n = V) {
    if (c(this, "history"), c(this, "ee", new D()), c(this, "attached", false), c(this, "back", () => this.go(-1)), c(this, "on", this.ee.on.bind(this.ee)), c(this, "off", this.ee.off.bind(this.ee)), this._index = s, this.postEvent = n, t.length === 0)
   ...
   */
  attach() {
    this.attached || (this.attached = true, this.sync(), y("back_button_pressed", this.back));
  }
  /**
   ...
   */
  detach() {
    this.attached = false, z("back_button_pressed", this.back);
  }
  /**
...
var ee = class {
  constructor(t, s, { postEvent: n, hashMode: r = "classic", base: i } = {}) {
    c(this, "navigator"), c(this, "ee", new D()), c(this, "hashMode"), c(this, "base"), c(this, "attached", false), c(this, "onPopState", ({ state: o }) => {
      if (o === null)
   ...
   */
  async attach() {
    this.attached || (this.attached = true, this.navigator.attach(), window.addEventListener("popstate", this.onPopState), await this.syncHistory());
  }
  /**
   ...
   */
  detach() {
    this.attached = false, this.navigator.detach(), window.removeEventListener("popstate", this.onPopState);
  }
  /**
  ...
  function s(n) {
    return function(i, o, a) {
      return (h) => {
        ...
        return (0, import_jsx_runtime.jsx)(a, { ...p });
      };
    };
  }
  return [s(e), s(t)];
}
var se = (0, import_react.createContext)(void 0);
function Ns() {
  const e = (0, import_react.useContext)(se);
  if (!e)
...
function _(e) {
  function t(n) {
    const r = Ns(), [i, o] = (0, import_react.useState)(
      n ? void 0 : () => {
        if (Ts())
...
var [Zn, Xn] = d(on, an);
function tr(e) {
  const [t, s] = (0, import_react.useState)(() => e ? void 0 : nt());
  return (0, import_react.useEffect)(() => {
    e && s(nt());
  }, []), t;
}
...
function ir({ children: e, acceptCustomStyles: t, debug: s }) {
  const n = (0, import_react.useRef)(true), [r, i] = (0, import_react.useState)(/* @__PURE__ */ new Map()), o = (0, import_react.useRef)(r), a = (0, import_react.useCallback)(
    (p) => {
  ...
  return (0, import_react.useEffect)(() => (n.current = true, () => {
    n.current = false;
  ...
  }, []), (0, import_jsx_runtime.jsx)(se.Provider, { value: h, children: e });
}
export {
  Ne as BackButton,
