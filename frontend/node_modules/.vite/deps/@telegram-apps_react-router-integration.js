...
// node_modules/@telegram-apps/react-router-integration/dist/index.js
var import_react = __toESM(require_react());
var d = class _d extends Error {
  constructor(e, o, a) {
    super(o, { cause: a }), this.type = e, Object.setPrototypeOf(this, _d.prototype);
  }
};
function y(t, e, o) {
  return new d(t, e, o);
}
var O = "ERR_UNEXPECTED_TYPE";
var $ = "ERR_PARSE";
function h() {
...
function W(t) {
  const e = (0, import_react.useCallback)(() => ({
    ...
    hash: t.hash,
    search: t.search
  }), [t]), [o, a] = (0, import_react.useState)(e), r = (0, import_react.useCallback)((s, n, f) => {
    f || (f = {}), n === void 0 && (n = f.state);
    const g = m(s);
    f.replace ? t.replace(g, n) : t.push(g, n);
  }, [t]), c = (0, import_react.useMemo)(() => ({
    go(s) {
      t.go(s);
    },
    push: r,
  ...
  return (0, import_react.useEffect)(() => t.on("change", () => a(e())), [t, e]), [o, c];
}
export {
  W as useIntegration
};
//# sourceMappingURL=@telegram-apps_react-router-integration.js.map
