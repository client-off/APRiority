...
var Ee = g("date", (e) => e instanceof Date ? e : new Date(P()(e) * 1e3));
function z(e, t) {
...
var ye = (e) => {
  const t = P(), n = P(true), r = l(), o = l(true), s = $(true), a = _(U({
...
var Ae = (e) => {
  const t = l(), n = l(true), r = $(true);
  return z({
    botInline: ["tgWebAppBotInline", r],
    initData: ["tgWebAppData", ye(true)],
...
function $e(e) {
  ...
  return s.set("tgWebAppPlatform", e.platform), s.set("tgWebAppThemeParams", X(e.themeParams)), s.set("tgWebAppVersion", e.version), t && s.set("tgWebAppData", t), n && s.set("tgWebAppStartParam", n), typeof r == "boolean" && s.set("tgWebAppShowSettings", r ? "1" : "0"), typeof o == "boolean" && s.set("tgWebAppBotInline", o ? "1" : "0"), s.toString();
}
var Y = _({
  eventType: l(),
  eventData: (e) => e
...
var je = (e, t, n) => t in e ? Ue(e, t, { enumerable: true, configurable: true, writable: true, value: n }) : e[t] = n;
var te = (e, t, n) => je(e, typeof t != "symbol" ? t + "" : t, n);
var b = class _b extends Error {
  constructor(t, n, r) {
    ...
    ), this.type = t, Object.setPrototypeOf(this, _b.prototype);
  }
};
function x(e, t, n) {
...
var w = class _w extends Promise {
  constructor(t, n) {
    let r, o;
...
var Be = "ERR_METHOD_UNSUPPORTED";
var He = "ERR_RETRIEVE_LP_FAILED";
var Ge = "ERR_METHOD_PARAMETER_UNSUPPORTED";
var Ve = "ERR_UNKNOWN_ENV";
var Ke = "ERR_INVOKE_CUSTOM_METHOD_RESPONSE";
var ue = E("https://web.telegram.org");
function pe(e, t) {
...
function _t(e) {
  ...
  return w.withFn(async () => {
    if (ee(window))
      return true;
    try {
      return await fe("web_app_request_theme", "theme_changed", { timeout: 100 }), true;
    } catch {
      return false;
    }
  }, e);
...
//# sourceMappingURL=@telegram-apps_bridge.js.map
