...
var Cell = (0, import_react13.forwardRef)((_param, ref) => {
  ...
  const platform2 = usePlatform();
  const { Title: Title2, Description } = useTypographyCellComponents();
    ...
    children: [
      ...
      (0, import_jsx_runtime10.jsxs)("div", {
        ...
        children: [
          ...
          hasTitle && (0, import_jsx_runtime10.jsxs)(Title2, {
          ...
          hasReactNode(description) && (0, import_jsx_runtime10.jsx)(Description, {
...
var Steps = ({ className, count, progress }) => (0, import_jsx_runtime59.jsx)("div", {
...
var usePagination = ({ boundaryCount = 1, count = 1, defaultPage = 1, hideNextButton = false, hidePrevButton = false, onChange, page: pageProp, siblingCount = 1 }) => {
  ...
  return itemList.map((typeOrPageNumber) => {
    ...
    return {
      ...
      disabled: ![
        PaginationType.StartEllipsis,
        PaginationType.EndEllipsis
      ].includes(typeOrPageNumber) && (typeOrPageNumber === PaginationType.Next ? page >= count : page <= 1)
    };
  });
};
  ...
  return (0, import_jsx_runtime128.jsx)("div", _object_spread_props(_object_spread({
    ...
    children: paginationItems.map((item) => {
      ...
      return (0, import_jsx_runtime128.jsx)(Headline, {
        ...
        onClick: item.disabled || isEllipsis ? void 0 : item.onClick,
...
var SegmentedControl = (_param) => {
  ...
  const platform2 = usePlatform();
  const childrenAsArray = import_react54.Children.toArray(children);
  const checkedIndex = childrenAsArray.findIndex((option) => {
    return (0, import_react54.isValidElement)(option) && option.props.selected;
  });
...
function $c512c27ab02ef895$export$fd42f52fd3ae1109(rootComponentName, defaultContext) {
  const Context = (0, import_react57.createContext)(defaultContext);
  function Provider(props) {
    ...
    return (0, import_react57.createElement)(Context.Provider, {
      value
    }, children);
  }
  function useContext9(consumerName) {
    const context = (0, import_react57.useContext)(Context);
    if (context)
      return context;
...
function $c512c27ab02ef895$export$50c7b4e9d9f19c1(scopeName, createContextScopeDeps = []) {
  ...
  function $c512c27ab02ef895$export$fd42f52fd3ae11092(rootComponentName, defaultContext) {
    const BaseContext = (0, import_react57.createContext)(defaultContext);
  ...
  const createScope = () => {
    const scopeContexts = defaultContexts.map((defaultContext) => {
      return (0, import_react57.createContext)(defaultContext);
    });
...
var $9f79659886946c16$export$e5c5a5f917a5871c = Boolean(globalThis === null || globalThis === void 0 ? void 0 : globalThis.document) ? import_react58.useLayoutEffect : () => {
};
...
function $b1b2314f5f9a1d84$export$25bec8c6f54ee79a(callback) {
  const callbackRef = (0, import_react59.useRef)(callback);
...
function $71cd76cc60e0454e$export$6f32135080cb4c3({ prop, defaultProp, onChange = () => {
  ...
  const setValue = (0, import_react60.useCallback)((nextValue) => {
    if (isControlled) {
...
function $71cd76cc60e0454e$var$useUncontrolledState({ defaultProp, onChange }) {
  const uncontrolledState = (0, import_react60.useState)(defaultProp);
  const [value] = uncontrolledState;
  const prevValueRef = (0, import_react60.useRef)(value);
  const handleChange = $b1b2314f5f9a1d84$export$25bec8c6f54ee79a(onChange);
...
var $5e63c961fc1ce211$export$8c6ed5c666ac1360 = (0, import_react61.forwardRef)((props, forwardedRef) => {
  ...
  if (slottable) {
    ...
    const newChildren = childrenArray.map((child) => {
      if (child === slottable) {
        ...
        return (0, import_react61.isValidElement)(newElement) ? newElement.props.children : null;
      } else
        return child;
    });
    return (0, import_react61.createElement)($5e63c961fc1ce211$var$SlotClone, _extends2({}, slotProps, {
      ref: forwardedRef
    }), (0, import_react61.isValidElement)(newElement) ? (0, import_react61.cloneElement)(newElement, void 0, newChildren) : null);
  }
  return (0, import_react61.createElement)($5e63c961fc1ce211$var$SlotClone, _extends2({}, slotProps, {
    ref: forwardedRef
  }), children);
...
var $5e63c961fc1ce211$var$SlotClone = (0, import_react61.forwardRef)((props, forwardedRef) => {
  const { children, ...slotProps } = props;
  if ((0, import_react61.isValidElement)(children))
    return (0, import_react61.cloneElement)(children, {
...
var $5e63c961fc1ce211$export$d9f1ccf0bdb05d45 = ({ children }) => {
  return (0, import_react61.createElement)(import_react61.Fragment, null, children);
};
function $5e63c961fc1ce211$var$isSlottable(child) {
  return (0, import_react61.isValidElement)(child) && child.type === $5e63c961fc1ce211$export$d9f1ccf0bdb05d45;
}
...
var $8927f6f2acc4f386$export$250ffa63cdc0d034 = $8927f6f2acc4f386$var$NODES.reduce((primitive, node) => {
  const Node2 = (0, import_react62.forwardRef)((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? $5e63c961fc1ce211$export$8c6ed5c666ac1360 : node;
    (0, import_react62.useEffect)(() => {
      window[Symbol.for("radix-ui")] = true;
    }, []);
    return (0, import_react62.createElement)(Comp, _extends2({}, primitiveProps, {
      ref: forwardedRef
    }));
  });
...
var $5cb92bef7577960e$var$DismissableLayerContext = (0, import_react64.createContext)({
  layers: /* @__PURE__ */ new Set(),
  layersWithOutsidePointerEventsDisabled: /* @__PURE__ */ new Set(),
  branches: /* @__PURE__ */ new Set()
});
var $5cb92bef7577960e$export$177fb62ff3ec1f22 = (0, import_react64.forwardRef)((props, forwardedRef) => {
  var _node$ownerDocument;
  const { disableOutsidePointerEvents = false, onEscapeKeyDown, onPointerDownOutside, onFocusOutside, onInteractOutside, onDismiss, ...layerProps } = props;
  const context = (0, import_react64.useContext)($5cb92bef7577960e$var$DismissableLayerContext);
  const [node1, setNode] = (0, import_react64.useState)(null);
  const ownerDocument = (_node$ownerDocument = node1 === null || node1 === void 0 ? void 0 : node1.ownerDocument) !== null && _node$ownerDocument !== void 0 ? _node$ownerDocument : globalThis === null || globalThis === void 0 ? void 0 : globalThis.document;
  const [, force] = (0, import_react64.useState)({});
  ...
  return (0, import_react64.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.div, _extends2({}, layerProps, {
    ref: composedRefs,
    style: {
...
var $5cb92bef7577960e$export$4d5eb2109db14228 = (0, import_react64.forwardRef)((props, forwardedRef) => {
  const context = (0, import_react64.useContext)($5cb92bef7577960e$var$DismissableLayerContext);
  ...
  return (0, import_react64.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.div, _extends2({}, props, {
    ref: composedRefs
  }));
});
...
function $5cb92bef7577960e$var$usePointerDownOutside(onPointerDownOutside, ownerDocument = globalThis === null || globalThis === void 0 ? void 0 : globalThis.document) {
  ...
  const isPointerInsideReactTreeRef = (0, import_react64.useRef)(false);
  const handleClickRef = (0, import_react64.useRef)(() => {
  });
  (0, import_react64.useEffect)(() => {
...
function $5cb92bef7577960e$var$useFocusOutside(onFocusOutside, ownerDocument = globalThis === null || globalThis === void 0 ? void 0 : globalThis.document) {
  ...
  const isFocusInsideReactTreeRef = (0, import_react64.useRef)(false);
  (0, import_react64.useEffect)(() => {
...
var $d3863c46a17e8a28$export$20e40289641fbbb6 = (0, import_react65.forwardRef)((props, forwardedRef) => {
  const { loop = false, trapped = false, onMountAutoFocus: onMountAutoFocusProp, onUnmountAutoFocus: onUnmountAutoFocusProp, ...scopeProps } = props;
  const [container1, setContainer] = (0, import_react65.useState)(null);
  const onMountAutoFocus = $b1b2314f5f9a1d84$export$25bec8c6f54ee79a(onMountAutoFocusProp);
  const onUnmountAutoFocus = $b1b2314f5f9a1d84$export$25bec8c6f54ee79a(onUnmountAutoFocusProp);
  const lastFocusedElementRef = (0, import_react65.useRef)(null);
  const composedRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(
    forwardedRef,
    (node) => setContainer(node)
  );
  const focusScope = (0, import_react65.useRef)({
    paused: false,
    pause() {
      this.paused = true;
    },
  ...
  const handleKeyDown = (0, import_react65.useCallback)((event) => {
    if (!loop && !trapped)
      return;
  ...
  return (0, import_react65.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.div, _extends2({
    tabIndex: -1
  }, scopeProps, {
    ref: composedRefs,
...
var $f1701beae083dbae$export$602eac185826482c = (0, import_react66.forwardRef)((props, forwardedRef) => {
  var _globalThis$document;
  const { container = globalThis === null || globalThis === void 0 ? void 0 : (_globalThis$document = globalThis.document) === null || _globalThis$document === void 0 ? void 0 : _globalThis$document.body, ...portalProps } = props;
  return container ? import_react_dom6.default.createPortal((0, import_react66.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.div, _extends2({}, portalProps, {
    ref: forwardedRef
  })), container) : null;
});
...
var $921a889cee6df7e8$export$99c2b779aa4e8b8b = (props) => {
  ...
  }) : import_react67.Children.only(children);
  const ref = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(presence.ref, child.ref);
  const forceMount = typeof children === "function";
  return forceMount || presence.isPresent ? (0, import_react67.cloneElement)(child, {
    ref
  }) : null;
};
$921a889cee6df7e8$export$99c2b779aa4e8b8b.displayName = "Presence";
function $921a889cee6df7e8$var$usePresence(present) {
  const [node1, setNode] = (0, import_react67.useState)();
  const stylesRef = (0, import_react67.useRef)({});
  const prevPresentRef = (0, import_react67.useRef)(present);
  const prevAnimationNameRef = (0, import_react67.useRef)("none");
...
function useCallbackRef(initialValue, callback) {
  var ref = (0, import_react69.useState)(function() {
    return {
      // value
      value: initialValue,
      // last callback
...
var RemoveScroll = React7.forwardRef(function(props, parentRef) {
  ...
  return React7.createElement(
    React7.Fragment,
    null,
    enabled && React7.createElement(SideCar2, { sideCar: effectCar, removeScrollBar, shards, noIsolation, inert, setCallbacks, allowPinchZoom: !!allowPinchZoom, lockRef: ref }),
...
function RemoveScrollSideCar(props) {
  ...
  var Style2 = React10.useState(function() {
  ...
  return React10.createElement(
    ...
    removeScrollBar ? React10.createElement(RemoveScrollBar, { gapMode: "margin" }) : null
  );
}
...
var $5d3850c4d0b4e6c7$export$3ddf2d174ce01153 = (props) => {
  ...
  return (0, import_react72.createElement)($5d3850c4d0b4e6c7$var$DialogProvider, {
    scope: __scopeDialog,
    triggerRef,
    contentRef,
...
var $5d3850c4d0b4e6c7$export$2e1e1122cf0cba88 = (0, import_react72.forwardRef)((props, forwardedRef) => {
  const { __scopeDialog, ...triggerProps } = props;
  const context = $5d3850c4d0b4e6c7$var$useDialogContext($5d3850c4d0b4e6c7$var$TRIGGER_NAME, __scopeDialog);
  const composedTriggerRef = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(forwardedRef, context.triggerRef);
  return (0, import_react72.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.button, _extends2({
    type: "button",
...
var $5d3850c4d0b4e6c7$export$dad7c95542bacce0 = (props) => {
  ...
  return (0, import_react72.createElement)($5d3850c4d0b4e6c7$var$PortalProvider, {
    scope: __scopeDialog,
    forceMount
  }, import_react72.Children.map(
    children,
    (child) => (0, import_react72.createElement)($921a889cee6df7e8$export$99c2b779aa4e8b8b, {
      present: forceMount || context.open
    }, (0, import_react72.createElement)($f1701beae083dbae$export$602eac185826482c, {
      asChild: true,
      container
    }, child))
  ));
...
var $5d3850c4d0b4e6c7$export$bd1d06c79be19e17 = (0, import_react72.forwardRef)((props, forwardedRef) => {
  const portalContext = $5d3850c4d0b4e6c7$var$usePortalContext($5d3850c4d0b4e6c7$var$OVERLAY_NAME, props.__scopeDialog);
  const { forceMount = portalContext.forceMount, ...overlayProps } = props;
  const context = $5d3850c4d0b4e6c7$var$useDialogContext($5d3850c4d0b4e6c7$var$OVERLAY_NAME, props.__scopeDialog);
  return context.modal ? (0, import_react72.createElement)($921a889cee6df7e8$export$99c2b779aa4e8b8b, {
    present: forceMount || context.open
  }, (0, import_react72.createElement)($5d3850c4d0b4e6c7$var$DialogOverlayImpl, _extends2({}, overlayProps, {
    ref: forwardedRef
  }))) : null;
});
...
var $5d3850c4d0b4e6c7$var$DialogOverlayImpl = (0, import_react72.forwardRef)((props, forwardedRef) => {
  const { __scopeDialog, ...overlayProps } = props;
  const context = $5d3850c4d0b4e6c7$var$useDialogContext($5d3850c4d0b4e6c7$var$OVERLAY_NAME, __scopeDialog);
  return (
    // Make sure `Content` is scrollable even when it doesn't live inside `RemoveScroll`
    // ie. when `Overlay` and `Content` are siblings
    (0, import_react72.createElement)(Combination_default, {
      as: $5e63c961fc1ce211$export$8c6ed5c666ac1360,
      allowPinchZoom: true,
      shards: [
        context.contentRef
      ]
    }, (0, import_react72.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.div, _extends2({
      "data-state": $5d3850c4d0b4e6c7$var$getState(context.open)
    }, overlayProps, {
      ref: forwardedRef,
      style: {
...
var $5d3850c4d0b4e6c7$export$b6d9565de1e068cf = (0, import_react72.forwardRef)((props, forwardedRef) => {
  const portalContext = $5d3850c4d0b4e6c7$var$usePortalContext($5d3850c4d0b4e6c7$var$CONTENT_NAME, props.__scopeDialog);
  const { forceMount = portalContext.forceMount, ...contentProps } = props;
  const context = $5d3850c4d0b4e6c7$var$useDialogContext($5d3850c4d0b4e6c7$var$CONTENT_NAME, props.__scopeDialog);
  return (0, import_react72.createElement)($921a889cee6df7e8$export$99c2b779aa4e8b8b, {
    present: forceMount || context.open
  }, context.modal ? (0, import_react72.createElement)($5d3850c4d0b4e6c7$var$DialogContentModal, _extends2({}, contentProps, {
    ref: forwardedRef
  })) : (0, import_react72.createElement)($5d3850c4d0b4e6c7$var$DialogContentNonModal, _extends2({}, contentProps, {
    ref: forwardedRef
  })));
});
...
var $5d3850c4d0b4e6c7$var$DialogContentModal = (0, import_react72.forwardRef)((props, forwardedRef) => {
  const context = $5d3850c4d0b4e6c7$var$useDialogContext($5d3850c4d0b4e6c7$var$CONTENT_NAME, props.__scopeDialog);
  const contentRef = (0, import_react72.useRef)(null);
  ...
  return (0, import_react72.createElement)($5d3850c4d0b4e6c7$var$DialogContentImpl, _extends2({}, props, {
    ref: composedRefs,
...
var $5d3850c4d0b4e6c7$var$DialogContentNonModal = (0, import_react72.forwardRef)((props, forwardedRef) => {
  const context = $5d3850c4d0b4e6c7$var$useDialogContext($5d3850c4d0b4e6c7$var$CONTENT_NAME, props.__scopeDialog);
  const hasInteractedOutsideRef = (0, import_react72.useRef)(false);
  const hasPointerDownOutsideRef = (0, import_react72.useRef)(false);
  return (0, import_react72.createElement)($5d3850c4d0b4e6c7$var$DialogContentImpl, _extends2({}, props, {
    ref: forwardedRef,
    trapFocus: false,
...
var $5d3850c4d0b4e6c7$var$DialogContentImpl = (0, import_react72.forwardRef)((props, forwardedRef) => {
  const { __scopeDialog, trapFocus, onOpenAutoFocus, onCloseAutoFocus, ...contentProps } = props;
  const context = $5d3850c4d0b4e6c7$var$useDialogContext($5d3850c4d0b4e6c7$var$CONTENT_NAME, __scopeDialog);
  const contentRef = (0, import_react72.useRef)(null);
  const composedRefs = $6ed0406888f73fc4$export$c7b2cbe3552a0d05(forwardedRef, contentRef);
  $3db38b7d1fb3fe6a$export$b7ece24a22aeda8c();
  return (0, import_react72.createElement)(import_react72.Fragment, null, (0, import_react72.createElement)($d3863c46a17e8a28$export$20e40289641fbbb6, {
    asChild: true,
    loop: true,
    trapped: trapFocus,
    onMountAutoFocus: onOpenAutoFocus,
    onUnmountAutoFocus: onCloseAutoFocus
  }, (0, import_react72.createElement)($5cb92bef7577960e$export$177fb62ff3ec1f22, _extends2({
    role: "dialog",
...
var $5d3850c4d0b4e6c7$export$16f7638e4a34b909 = (0, import_react72.forwardRef)((props, forwardedRef) => {
  const { __scopeDialog, ...titleProps } = props;
  const context = $5d3850c4d0b4e6c7$var$useDialogContext($5d3850c4d0b4e6c7$var$TITLE_NAME, __scopeDialog);
  return (0, import_react72.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.h2, _extends2({
    id: context.titleId
  }, titleProps, {
    ref: forwardedRef
  }));
...
var $5d3850c4d0b4e6c7$export$94e94c2ec2c954d5 = (0, import_react72.forwardRef)((props, forwardedRef) => {
  const { __scopeDialog, ...descriptionProps } = props;
  const context = $5d3850c4d0b4e6c7$var$useDialogContext($5d3850c4d0b4e6c7$var$DESCRIPTION_NAME, __scopeDialog);
  return (0, import_react72.createElement)($8927f6f2acc4f386$export$250ffa63cdc0d034.p, _extends2({
...
var $5d3850c4d0b4e6c7$export$fba2fb7cd781b7ac = (0, import_react72.forwardRef)((props, forwardedRef) => {
...
var DrawerContext = import_react73.default.createContext({
  drawerRef: {
    current: null
  },
  overlayRef: {
...
var useDrawerContext = () => import_react73.default.useContext(DrawerContext);
...
var useIsomorphicLayoutEffect2 = typeof window !== "undefined" ? import_react73.useLayoutEffect : import_react73.useEffect;
...
function usePositionFixed({ isOpen, modal, nested, hasBeenOpened, preventScrollRestoration }) {
  const [activeUrl, setActiveUrl] = import_react73.default.useState(typeof window !== "undefined" ? window.location.href : "");
  const scrollPos = import_react73.default.useRef(0);
  const setPositionFixed = import_react73.default.useCallback(() => {
  ...
  const restorePositionSetting = import_react73.default.useCallback(() => {
...
function useCallbackRef2(callback) {
  const callbackRef = import_react73.default.useRef(callback);
  import_react73.default.useEffect(() => {
    callbackRef.current = callback;
  });
  return import_react73.default.useMemo(() => (...args) => callbackRef.current == null ? void 0 : callbackRef.current.call(callbackRef, ...args), []);
}
function useUncontrolledState({ defaultProp, onChange }) {
  const uncontrolledState = import_react73.default.useState(defaultProp);
  const [value] = uncontrolledState;
  const prevValueRef = import_react73.default.useRef(value);
...
function useControllableState({ prop, defaultProp, onChange = () => {
  ...
  const handleChange = useCallbackRef2(onChange);
  const setValue = import_react73.default.useCallback((nextValue) => {
    if (isControlled) {
      const setter = nextValue;
...
function useSnapPoints({ activeSnapPointProp, setActiveSnapPointProp, snapPoints, drawerRef, overlayRef, fadeFromIndex, onSnapPointChange, direction = "bottom" }) {
  ...
  const isLastSnapPoint = import_react73.default.useMemo(() => activeSnapPoint === (snapPoints == null ? void 0 : snapPoints[snapPoints.length - 1]) || null, [
    snapPoints,
    activeSnapPoint
  ]);
  const shouldFade = snapPoints && snapPoints.length > 0 && (fadeFromIndex || fadeFromIndex === 0) && !Number.isNaN(fadeFromIndex) && snapPoints[fadeFromIndex] === activeSnapPoint || !snapPoints;
  const activeSnapPointIndex = import_react73.default.useMemo(() => snapPoints == null ? void 0 : snapPoints.findIndex((snapPoint) => snapPoint === activeSnapPoint), [
    snapPoints,
    activeSnapPoint
  ]);
  const snapPointsOffset = import_react73.default.useMemo(() => {
    var _snapPoints_map;
  ...
  const activeSnapPointOffset = import_react73.default.useMemo(() => activeSnapPointIndex !== null ? snapPointsOffset == null ? void 0 : snapPointsOffset[activeSnapPointIndex] : null, [
    snapPointsOffset,
    activeSnapPointIndex
  ]);
  const snapToPoint = import_react73.default.useCallback((dimension) => {
...
function Root({ open: openProp, onOpenChange, children, shouldScaleBackground, onDrag: onDragProp, onRelease: onReleaseProp, snapPoints, nested = false, closeThreshold = CLOSE_THRESHOLD, scrollLockTimeout = SCROLL_LOCK_TIMEOUT, dismissible = true, fadeFromIndex = snapPoints && snapPoints.length - 1, activeSnapPoint: activeSnapPointProp, setActiveSnapPoint: setActiveSnapPointProp, fixed, modal = true, onClose, direction = "bottom", preventScrollRestoration = true, disablePreventScroll = false }) {
  ...
  const [isOpen = false, setIsOpen] = import_react73.default.useState(false);
  const [hasBeenOpened, setHasBeenOpened] = import_react73.default.useState(false);
  const [visible, setVisible] = import_react73.default.useState(false);
  const [mounted, setMounted] = import_react73.default.useState(false);
  const [isDragging, setIsDragging] = import_react73.default.useState(false);
  const [justReleased, setJustReleased] = import_react73.default.useState(false);
  const overlayRef = import_react73.default.useRef(null);
  const openTime = import_react73.default.useRef(null);
  const dragStartTime = import_react73.default.useRef(null);
  const dragEndTime = import_react73.default.useRef(null);
  const lastTimeDragPrevented = import_react73.default.useRef(null);
  const isAllowedToDrag = import_react73.default.useRef(false);
  const nestedOpenChangeTimer = import_react73.default.useRef(null);
  const pointerStart = import_react73.default.useRef(0);
  const keyboardIsOpen = import_react73.default.useRef(false);
  const previousDiffFromInitial = import_react73.default.useRef(0);
  const drawerRef = import_react73.default.useRef(null);
  const drawerHeightRef = import_react73.default.useRef(((_drawerRef_current = drawerRef.current) == null ? void 0 : _drawerRef_current.getBoundingClientRect().height) || 0);
  const initialDrawerHeight = import_react73.default.useRef(0);
  const onSnapPointChange = import_react73.default.useCallback((activeSnapPointIndex2) => {
  ...
  return import_react73.default.createElement($5d3850c4d0b4e6c7$export$be92b6f5f03c0fe9, {
    modal,
    onOpenChange: (o) => {
      if (openProp !== void 0) {
    ...
    open: isOpen
  }, import_react73.default.createElement(DrawerContext.Provider, {
    value: {
      visible,
      activeSnapPoint,
      snapPoints,
...
var Overlay = import_react73.default.forwardRef(function({ children, ...rest }, ref) {
  const { overlayRef, snapPoints, onRelease, shouldFade, isOpen, visible } = useDrawerContext();
  const composedRef = useComposedRefs(ref, overlayRef);
  const hasSnapPoints = snapPoints && snapPoints.length > 0;
  return import_react73.default.createElement($5d3850c4d0b4e6c7$export$c6fdb837b070b4ff, {
    onMouseUp: onRelease,
    ref: composedRef,
...
var Content = import_react73.default.forwardRef(function({ onOpenAutoFocus, onPointerDownOutside, onAnimationEnd, style, ...rest }, ref) {
  ...
  const pointerStartRef = import_react73.default.useRef(null);
  import_react73.default.useEffect(() => {
    setVisible(true);
  }, []);
  ...
  return import_react73.default.createElement($5d3850c4d0b4e6c7$export$7c6e2c02157bb7d2, {
    "vaul-drawer": "",
...
function NestedRoot({ onDrag, onOpenChange, ...rest }) {
  ...
  return import_react73.default.createElement(Root, {
    nested: true,
    onClose: () => {
...
var ModalClose = (props) => (0, import_jsx_runtime133.jsx)(Drawer.Close, _object_spread({
  asChild: true
}, props));
...
var ModalHeader = (0, import_react74.forwardRef)((_param, ref) => {
  ...
  const platform2 = usePlatform();
  return (0, import_jsx_runtime134.jsxs)("header", _object_spread_props(_object_spread({
    ref,
    ...
    children: [
      ...
      platform2 === "ios" && (0, import_jsx_runtime134.jsx)(Text, {
        weight: "2",
...
var ModalOverlay = (0, import_react75.forwardRef)((_param, ref) => {
  var { className } = _param, props = _object_without_properties(_param, [
    "className"
  ]);
  const context = useAppRootContext();
  const [r, g, b] = (0, import_react75.useMemo)(() => {
  ...
  return (0, import_jsx_runtime135.jsx)(Drawer.Overlay, _object_spread({
    ref,
...
// node_modules/@telegram-apps/telegram-ui/dist/components/Overlays/Modal/Modal.js
var Modal = (0, import_react76.forwardRef)((_param, ref) => {
  var { overlayComponent = (0, import_jsx_runtime136.jsx)(ModalOverlay, {}), open, onOpenChange, header, className, children, nested, trigger, closeThreshold, scrollLockTimeout, snapPoints, fadeFromIndex, modal, preventScrollRestoration, dismissible } = _param, restProps = _object_without_properties(_param, [
    "overlayComponent",
    "open",
    "onOpenChange",
    "header",
  ...
  const [portal, setPortal] = (0, import_react76.useState)((_container_portalContainer = container.portalContainer) === null || _container_portalContainer === void 0 ? void 0 : _container_portalContainer.current);
  ...
  return (0, import_jsx_runtime136.jsxs)(Component, {
    open,
    onOpenChange,
    closeThreshold,
    scrollLockTimeout,
    ...
    dismissible,
    children: [
      trigger && (0, import_jsx_runtime136.jsx)(Drawer.Trigger, {
        asChild: true,
        children: trigger
      }),
      (0, import_jsx_runtime136.jsxs)(Drawer.Portal, {
        container: portal,
        children: [
          overlayComponent,
          (0, import_jsx_runtime136.jsxs)(Drawer.Content, _object_spread_props(_object_spread({
            ref,
...
var Tooltip = (_param) => {
  ...
  return (0, import_jsx_runtime137.jsx)(Popper, _object_spread_props(_object_spread({
    withArrow: true,
    ...
    children: (0, import_jsx_runtime137.jsx)(Caption, {
      level: "1",
      children
    })
  }));
...
var useAppearance = (appearanceProp) => {
  const { appearance: contextAppearance } = (0, import_react77.useContext)(AppRootContext);
  const [appearance, setAppearance] = (0, import_react77.useState)(appearanceProp || contextAppearance || getInitialAppearance());
  const handleThemeChange = (0, import_react77.useCallback)(() => {
    const telegramData = getTelegramData();
    if (!telegramData) {
      return;
    }
...
var usePlatform2 = (platform2) => {
  ...
  const appContext = (0, import_react78.useContext)(AppRootContext);
...
var usePortalContainer = (portalContainer) => {
  ...
  const appContext = (0, import_react79.useContext)(AppRootContext);
  if (appContext.isRendered && appContext.portalContainer !== void 0) {
    return appContext.portalContainer;
  }
  return (0, import_react79.useRef)(null);
};

// node_modules/@telegram-apps/telegram-ui/dist/components/Service/AppRoot/AppRoot.js
var AppRoot = (0, import_react80.forwardRef)((_param, ref) => {
  ...
  return (0, import_jsx_runtime138.jsx)("div", _object_spread_props(_object_spread({
    ...
    children: (0, import_jsx_runtime138.jsx)(AppRootContext.Provider, {
      value: contextValue,
      children
    })
  }));
